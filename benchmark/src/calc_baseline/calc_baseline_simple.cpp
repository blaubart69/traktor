...
bool __attribute__ ((noinline)) calc_baseline_delta_from_nearest_refline_simple(const int x_screen, const int y_screen, const CalcSettings& settings, int *delta_pixels)
{
    CoordPoint p;
